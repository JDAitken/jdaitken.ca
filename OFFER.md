...
Two tiers, not three. Both include the full marketing engine (site + SEO + GBP) so both can
honestly stand behind the guarantee. There is no website-only featured tier — see "Off-menu"
below for that case.
...
Value anchor: a custom build like this runs $2,000+ as a one-time project elsewhere. Here, setup
is $0 — it's included in the plan.
